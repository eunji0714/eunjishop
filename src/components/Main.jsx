        ...
        <section className={"relative"}>
            <div className={"overflow-hidden py-24 sm:py-32"}>
                <div className={"mx-auto max-w-7xl px-6 lg:px-8"}>
                    <div className={"mx-auto grid max-w2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2"}>
                        <div className={"lg:pt-12"}>
                            <div className={"lg:max-w-xl"}>
                                <h1 className={"text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-left"}>Welcome to the World of{' '}
                                    <span className={"block text-violet-500 lg:inline"}>Eunji shop</span>
                                </h1>
